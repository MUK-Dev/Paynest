...
class GiftCardForm extends StatefulWidget {
  static String id = '/buyGiftCard';
  @override
  _GiftCardFormState createState() => _GiftCardFormState();
}
